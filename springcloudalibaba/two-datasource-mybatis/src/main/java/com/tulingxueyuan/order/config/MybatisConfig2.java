...
@Configuration
@MapperScan(value = {"com.tulingxueyuan.order.dao2"},sqlSessionFactoryRef = "sqlSessionFactory2")
public class MybatisConfig2 {
    ...
    public DataSource dataSource(){
        ...
        druidDataSource.setUrl("jdbc:mysql://localhost:3306/seata_stock");
